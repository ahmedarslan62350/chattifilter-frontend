    ...
    <div className="relative overflow-hidden">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Beta Badge */}
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-green-700 text-white shadow-md">
              BETA
            </span>
          </div>
        </div>
      ...
      <section className="pt-20 pb-32 px-8 max-w-7xl mx-auto text-center relative">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed">
            Sutorium uses advanced AI to analyze thousands of comments,
            detecting audience signals, content opportunities, and high-value
            feedback in seconds.
          </p>
        ...
        >
          ...
          <div
            className="absolute -bottom-10 -right-10 glass p-6 rounded-2xl hidden lg:block animate-bounce-slow"
      ...
      <section id="features" className="py-32 px-8 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Stop drowning in notifications. Let Sutorium find the signals that
          ...
          {[
            {
              ...
              desc: "Multi level processing of comments across YouTube videos",
              icon: Zap,
            ...
            {
              title: "Competitor Intelligence (Soon)",
      ...
      <section className="py-32 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="glass-dark rounded-[40px] p-12 md:p-20 border border-white/10 relative overflow-hidden">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight">
                How to contact us <br /> and get started
              </h2>
              <p className="text-xl text-slate-400 max-w-2xl mx-auto">
                If you want early access, custom setup, or help understanding
                your audience data, you can contact us directly and we will
            ...
            <div className="grid md:grid-cols-3 gap-10 mb-16">
              <div className="rounded-3xl border border-white/10 p-8 text-center bg-white/5 backdrop-blur">
                <div className="text-4xl font-bold text-white mb-4">01</div>
                <h3 className="text-xl font-bold text-white mb-3">
                  Send a message
                </h3>
                <p className="text-slate-400">
                  Message us on WhatsApp and tell us about your channel,
                  platform, and what you want to achieve with Sutorium.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 p-8 text-center bg-white/5 backdrop-blur">
                ...
                <p className="text-slate-400">
                  We will explain how the platform works, what insights you will
                  get, and how it can improve your content strategy.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 p-8 text-center bg-white/5 backdrop-blur">
                ...
                <p className="text-slate-400">
                  After the conversation, you will get access and you can start
                  using the platform completely free.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-6 text-center">
              <a
                href="https://wa.me/923447264464"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-black px-14 py-6 rounded-full text-xl md:text-2xl font-bold hover:scale-105 transition-transform shadow-[0_0_50px_rgba(255,255,255,0.2)]"
              >
                Contact on WhatsApp to get started free
              </a>

              <p className="text-slate-500 text-sm">
                Direct onboarding • Fast response • Personal support
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              AI-driven audience intelligence for the next generation of content
              creators.
            </p>
          </div>
