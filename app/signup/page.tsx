      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="flex items-center gap-3 mb-10">
            ...
            <span className="font-bold text-3xl tracking-tight text-white">Sutorium</span>
          </div>
          <h1 className="text-5xl font-bold text-white mb-8 leading-tight">Start your journey to <br /> <span className="text-gradient">Audience Mastery</span></h1>
        ...
        >
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2">
              ...
              <input type="text" placeholder="John Doe" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-accent-cyan/50 transition-all" />
            </div>
            <div className="space-y-2">
